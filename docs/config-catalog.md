...
Source: [`packages/auth/auth-gate/src/index.ts:50`](../packages/auth/auth-gate/src/index.ts)
...
Source: [`packages/auth/authn-local/src/index.ts:41`](../packages/auth/authn-local/src/index.ts)
...
- `@deepseek-ai/dsh-auth` — abstract `AuthnService` ([`packages/auth/auth/src/index.ts`](../packages/auth/auth/src/index.ts))
