...
| [auth.md](auth.md) | the authentication seam: `AuthUser`/`UserId`, credential login, sliding-expiry bearer tokens, the management surface, the `AuthErrorCode` taxonomy, and the gate/login-page consumers |
